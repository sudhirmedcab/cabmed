          ...
          <div class="row">
            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
              <div class="form-group">
                ...
                <select disabled wire:change="partners()" wire:model="create_for" class="custom-select rounded-0 form-control form-control-sm" id="exampleSelectRounded0">
                  <option  value="">Select</option>
                  <option @if($create_for == 0) selected @endif value="0">Self</option>
                  <option @if($create_for == 1) selected @endif value="1">Partner</option>
                </select>
...
{{$partner_id}}
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
              <div class="form-group">
                ...
                <input wire:model="driver_mobile" disabled type="text" class="rounded-0 form-control form-control-sm" id="driver_mobile" placeholder="Enter Driver Mobile">
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
              <div class="form-group">
                ...
                <input wire:model="driver_dob" type="date" class="rounded-0 form-control form-control-sm" id="driver_dob" placeholder="Enter Driver Mobile">
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
              <div class="form-group">
                ...
                <input wire:model="vehicle_rc_no" type="text"  {{ $partner_id ? 'disabled' : '' }}  @if($isStep1FormSubmitted) disabled @endif class="text__uppercase rounded-0 form-control form-control-sm" id="vehicle_rc_no" placeholder="Enter Vehicle RC No.">
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
              <div class="form-group">
                ...
                <input type="file" wire:model="driver_profile_image" accept=".jpeg,.jpg,.png" class="rounded-0 form-control form-control-sm" id="profile_image" placeholder="Enter Vehicle RC No.">
      ...
      <div class="card-body py-1 pb-3 ">
        <form wire:submit.prevent="step2Form">
          <div class="row">
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
              <div class="form-group">
                ...
                <input wire:model="driver_pan_no" type="text" class="text__uppercase rounded-0 form-control form-control-sm" id="driver_first_name" placeholder="Enter PAN Number">
          ...
          <button type="submit"
                       wire:loading.attr="disabled" 
                        class="mt-2 rounded-0 form-control form-control-sm btn-primary">
                       <i wire:loading wire:target="step2Form" class="fa fa-spinner fa-spin mt-2 ml-2"></i>
                        Update 
                       </button>
        </form>
      </div>
      ...
      <div class="card-body py-1 pb-3">
        <form wire:submit.prevent="step3Form">
          <div class="row">
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
              <div class="form-group">
                ...
                <input wire:model="driver_dl_no" type="text" class="text__uppercase rounded-0 form-control form-control-sm" id="driver_first_name" placeholder="Enter dl number">
          ...
          <button type="submit"
                       wire:loading.attr="disabled" 
                       class="mt-2 rounded-0 form-control form-control-sm btn-primary">
                       <i wire:loading wire:target="step3Form" class="fa fa-spinner fa-spin mt-2 ml-2"></i>
                       Update
                      </button>
        </form>
      </div>
    ...
    <!-- Ambulance Details -->
    <div class="{{ $partner_id ? 'd-none' : '' }} @if($isStep1FormSubmitted && $isStep2FormSubmitted && $isStep3FormSubmitted && $isStep4FormSubmitted) custom__card @endif card card-default add__driver__form">
      <div class="card-header align-items-center d-flex">
          ...
          <div class="row">
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 ">
              ...
              <button type="submit"
                       wire:loading.attr="disabled" 
                       class="mt-2 rounded-0 form-control form-control-sm btn-primary">
                       <i wire:loading wire:target="step4Form" class="fa fa-spinner fa-spin mt-2 ml-2"></i>
                        Update
              </button>
            </div>
          </div>
    ...
    <!-- Ambulance Fitness -->
    <div class="{{ $partner_id ? 'd-none' : ''}} @if($isStep1FormSubmitted && $isStep2FormSubmitted && $isStep3FormSubmitted && $isStep4FormSubmitted && $isStep5FormSubmitted) custom__card @endif card card-default add__driver__form">
      <div class="card-header align-items-center d-flex">
