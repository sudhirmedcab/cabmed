...
<div class="content">
    <div class="container-fluid">
        ...
        <div class="custom__driver__detail__section card px-3">
            {{-- <p class="text-center mt-4"> @if($labtestData->clo_status == '1')
                New
        ...
        <div class="custom__driver__detail__section card px-3">
            ...
            <table class="table m-0 table-sm custom__table table-bordered mt-3 mb-2">
                ...
                <tr>
                    ...
                    <td>@if(!empty($key->lab_owner_id))<a wire:navigate href="{{route('lab_details',['LabOwnerId' => Crypt::encrypt($key->lab_owner_id),'Details'=>'Details'])}}" class="text-primary"> {{($key->lab_owner_name) }} ({{$key->lab_owner_id }})</a> @else Not Availabe @endif</td>
