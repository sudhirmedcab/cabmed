    ...
    <div class="card card-default add__driver__form mt-2">
        ...
        <!-- <div class="card-header align-items-center d-flex">
            ...
            <div class="card-tools d-flex align-items-center ml-auto">
                ...
                <div class="col-3 ml-auto d-flex align-items-end justify-content-end rounded">
                    <a href="#" class="submit__btn text-primary font-weight-bold my-1 d-flex align-items-center justify-content-center text-white">
                        Submit
                    </a>
                </div>
            </div>
            ...
            <form wire:submit.prevent="autoSearchBookingStep1Form" class="mb-5">
                <div class="row">
                    ...
                    <div class="col-6 col-sm-auto col-md-2" style="margin-top: 20px;">
                        <button type="submit" wire:loading.attr="disabled" class="rounded text-white form-control form-control-sm btn-primary">
        ...
        @endphp
        <script type="text/javascript" src="https://maps.google.com/maps/api/js?key={{$googleMap->a_setting_value}}&libraries=places"></script>
        <script>
