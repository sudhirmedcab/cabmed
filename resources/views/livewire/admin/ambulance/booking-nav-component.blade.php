<div class="card text-center mt-2 mb-2">
    <div class="custom__driver__filter card-header">
        <ul class="nav nav-tabs custom__nav__tab  card-header-tabs d-flex justify-content-around overflow-auto flex-nowrap">
           <li class="nav-item {{  (Request::is('booking_invoice')) || ($this->activeTab == 'bookingDashboard') ? 'active':''}}">
                <a class="custom__nav__btn nav-link fs-1 " href="/booking_invoice" wire:click="filterCondition('bookingDashboard')">
                   Dashboard
                </a>
            </li>
