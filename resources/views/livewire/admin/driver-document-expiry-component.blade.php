                ...
                @if($this->activeTab !== 'documentExpiry')
                    ...
                    <div class="col __col-3">
                        <div class="form-group">
                            ...
                            <input type="search" wire:model.live.debounce.150ms="dexpnameSearch" class="custom__input__field form-control rounded-0 form-control-sm float-right" placeholder="Search">
                        </div>
                    </div>
                </div>
            ...
            <div wire:loading.remove wire:target="filterCondition" class="card-body p-2 overflow-auto">
                <table class="table custom__table table-bordered table-sm ">
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $list->driver_details_dl_exp_date }}
                        </td>

                        <td>{{ $list->city_name }}</td>
                        <td>{{ $list->state_name }}</td>
                        <td class="action__btn lbtn-group">
                            <button wire:click="edit({{ $list->driver_id }})" class="btn-primary"><i class="fa fa-edit fa-sm"></i></button>
                            <button  wire:navigate href="#" class="btn-success"><i class="fa fa-eye fa-sm"></i></button>
                            <button wire:confirm="Are you sure you want to delete this post?" wire:click="delete({{ $list->driver_id }})" class="btn-danger"><i class="fa fa-trash fa-sm"></i></button>
                        </td>
                    </tr>
                    @php
                    $srno++
